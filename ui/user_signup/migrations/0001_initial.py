# Generated by Django 3.0.3 on 2020-03-04 21:32
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('dietary_restrictions', multiselectfield.db.fields.MultiSelectField(choices=[('Vegetarian', 'Vegetarian'), ('Vegan', 'Vegan'), ('Peanut', 'Peanut')], max_length=23)),
            ],
        ),
        migrations.CreateModel(
            name='User_Data',
